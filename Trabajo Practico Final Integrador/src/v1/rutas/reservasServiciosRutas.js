...
router.get(
  '/:reserva_id',
  authenticateJWT,
  permit(1,2,3), // permitimos que admin/empleado/cliente puedan listar (ajustá si querés otra lógica)
...
router.post(
  '/',
  authenticateJWT,
  permit(1,2), // solo admin/empleado para agregar (ajustá si querés permitir a clientes)
  [
...
router.delete(
  '/:id',
  authenticateJWT,
  permit(1,2), // solo admin/empleado para eliminar (ajustá si querés permitir a cliente dueño)
